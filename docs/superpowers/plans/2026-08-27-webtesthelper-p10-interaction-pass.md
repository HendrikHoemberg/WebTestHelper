...
<!-- Filled in during execution. Per CLAUDE.md this section and the measured constants are the
     only content in this plan that cannot be regenerated by reading the code — never compress
     them to fit a length target, and never edit anything above this line after execution. -->
